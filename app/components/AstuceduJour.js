    ...
    render(){
        return(
            <View style={{flexDirection:'row', justifyContent:'center',backgroundColor:this.props.backgroundColor,borderRadius:20, marginLeft: 10, marginBottom:5, marginRight:10}}>
                  ...
                  <View style={{justifyContent:'center', marginLeft:70, flex:1, marginBottom:10}}>
                    <Text style={{color:this.props.fontcolor, textAlignVertical:'center'}}>{this.props.text}</Text>
                  </View>
                </View>
        )
