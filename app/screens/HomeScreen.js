            ...
            <View style={{flex:1}}>
              ...
              <View style={{flex:1}}>
                <ScrollView horizontal={true}
                                  ...
                                  <Category navigation={this.props.navigation} imageUri={require('../assets/crevettes.jpg')} name="Spaghettis aux crevettes et pesto" color='#32582B' fontcolor='#fff'></Category>
                                  <Category navigation={this.props.navigation} imageUri={require('../assets/crevettes.jpg')} name="Semoule aux olives" color='#fff' ></Category>
                                  <Category navigation={this.props.navigation} imageUri={require('../assets/crevettes.jpg')} name="Tiramisu aux framboises" color='#000' fontcolor='#fff'></Category>
                                  <Category navigation={this.props.navigation} imageUri={require('../assets/crevettes.jpg')} name="Quiche au thon" color='#fff'></Category>
                                  <Category navigation={this.props.navigation} imageUri={require('../assets/crevettes.jpg')} name="Gateau au chocolat" color='#32582B' fontcolor='#fff'></Category>     
                </ScrollView>
              </View>
            </View>
            <View>
